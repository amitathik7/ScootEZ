            ...
            .then(data => {
                ...
                if (!mapRef.current) {  
                    ...
                    scooters.forEach(scooter => {
                        const popupContent = ({ scooter }) => (
                            <div style={{ width: '190px', height: 'auto', maxHeight: '275px', overflow: 'auto', textAlign: 'center' }}>
                                ...
                                <p style={{ margin: '5px' }}>
                                    <Link to={`/admin/scooters/${scooter.id}`} style={{ textDecoration: 'none', color: 'blue' }}>Edit Details</Link>
                                </p>
                            </div>
                        );
